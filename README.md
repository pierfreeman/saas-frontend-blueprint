...
apps/
  ...
  admin/          — Admin MFE (port 4203): super-admin backoffice portal (org inspection, members, billing with plan change + trial extension, activity log, entitlement overrides, storage quota)
