...
- 📅 **Planning / Calendar** — FullCalendar with month/week/day views, recurring events (RRULE builder), drag-and-drop rescheduling, RSVP, live conflict checking, per-occurrence exceptions, IANA timezone selector, event reminder presets
...
| `@saas-frontend/planning/data-access`      | [→](libs/planning/data-access/README.md)      | `PlanningApi`, `PlanningStore` — calendar events CRUD, RSVP   |
| `@saas-frontend/planning/feature`          | [→](libs/planning/feature/README.md)          | Full calendar UI — FullCalendar, RRULE builder, reminder UX   |
